		 ...
		 describe("With children", () => {
			...
			describe("By Node Traversal", () => {
			   beforeAll(() => {
				  ...
				  treeRootFirstChild = tree.traverseTo(new Node(treeRootChildrenKey3));
				  level = tree.level;
				  height = tree.height;
				  console.log(treeRootFirstChild, level, height);
			   });
			   test.todo("Should have a first child.");
			   test.todo("Should have a last child.");
			});
		 });
	  });
   });
